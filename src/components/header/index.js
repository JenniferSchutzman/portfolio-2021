                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6">
                        <nav className="relative flex items-center justify-between sm:h-10 md:justify-center" aria-label="Global">
                            ...
                            <div className="hidden md:flex md:space-x-20">
                                ...
                                <a href="#" className="font-medium text-gray-500 hover:text-gray-900">Code</a>

                                <a href="#" className="font-medium text-gray-500 hover:text-gray-900">Tech Community</a>

                                <a href="#" className="font-medium text-gray-500 hover:text-gray-900">Before Software</a>
                            </div>
                            <div className="hidden md:absolute md:flex md:items-center md:justify-end md:inset-y-0 md:right-0">
                                {/* <span className="inline-flex rounded-md shadow">
                                    <a href="#" className="inline-flex items-center px-4 py-2 border border-transparent text-base font-medium rounded-md text-green-500 bg-white hover:bg-gray-50">
                                        Log in
                                    </a>
                                </span> */}
                            </div>
                    ...
                    <div className="absolute z-10 top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden">
                        <div className="rounded-lg shadow-md bg-white ring-1 ring-black ring-opacity-5 overflow-hidden">
                            ...
                            <div className="px-2 pt-2 pb-3">
                                ...
                                <a href="#" className="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50">Code</a>

                                <a href="#" className="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50">Tech Community</a>

                                <a href="#" className="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50">Before Software</a>
                            </div>
                            {/* <a href="#" className="block w-full px-5 py-3 text-center font-medium text-green-500 bg-gray-50 hover:bg-gray-100">
                                Log in
                            </a> */}
                        </div>
                    </div>
                ...
                <main className="mt-16 mx-auto max-w-7xl px-4 sm:mt-24">
                    <div className="text-center">
                        <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                            <div className=" flex  ">Front-end Software Engineer:</div>
                        ...
                        <div className="mt-5 max-w-md mx-auto sm:flex sm:justify-center md:mt-8">
                            ...
                            {/* <div className="mt-3 rounded-md shadow sm:mt-0 sm:ml-3">
                                <a href="#" className="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-green-500 bg-white hover:bg-gray-50 md:py-4 md:text-lg md:px-10">
                                    Live demo
                                </a>
                            </div> */}
                        </div>
