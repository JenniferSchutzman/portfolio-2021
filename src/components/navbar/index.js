                ...
                <div className="relative z-10 pb-8 bg-white sm:pb-16 md:pb-20 lg:max-w-2xl lg:w-full lg:pb-28 xl:pb-32">
                    ...
                    <div>
                        {/* <div className="relative pt-6 px-4 sm:px-6 lg:px-8">
                            ...
                            <nav className="relative  flex items-center justify-between sm:h-10 lg:justify-start bg-pink-500" aria-label="Global">
                        ...
                        {/* 
{mobileModal && (
                            <div className="absolute z-10 top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden bg-purple-500">
                                <div className="rounded-lg shadow-md bg-white ring-1 ring-black ring-opacity-5 overflow-hidden min-h-content bg-yellow-500">
                                    <div className="px-5 pt-4 flex items-center justify-between bg-gray-800">
                                        <div>
                                            <img className="h-8 w-auto" src="/images/logo.svg" alt="" />
                                        </div>
                                        <div className="-mr-4">
                                    ...
                                    <div className="px-2 pt-2 pb-3 space-y-1 bg-blue-500 min-h-full">
                                        {navItems.map(item => {
                                            return (
                                                <a href={item.href} className="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50">{item.name}</a>
                                            )
