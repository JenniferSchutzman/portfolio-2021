  ...
  gridSection: [
    {
      ...
      gridDescription: [
      //   `Shortly after moving to Charleston in 2017, I began attending any and every tech meetup.  
      ...
      // `Also a special shoutout to our sponsor GrubHub...thank you!`
    ],
    ...
    },
    {
      ...
      Working alongside CHSWIT Executive Director Nina Magnesson and Board Member Valerie Sessions, I paired over 100 women in tech with peer
      ...
      cocktail hour overlooking the river for all of the 100+ mentorship participants.` 
     // Today this program is still going strong thanks to our efforts in 2019 and I am grateful to have had the opportunity to meet countless phenomenol women in tech in the Charleston area from this experience.`
    ],
