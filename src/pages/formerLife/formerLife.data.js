...
const formerLifeData = {
  ...
  p: [
    ...
    I went back to Uganda for a full year, which was then followed by an additional year and
    ...
    After completing my post-grad degree, I lived in Sudan and South Sudan for 2 years and an additional 4 years in Washington DC
      ...
      social change in the community with evidence-based assertions.  I also often helped funders evaluate whether these projects were indeed creating the
      lasting and impactful social behavioural change for sustainable community improvement that they intended.`,
      
      `So why software development?  During that time I worked mostly in Advanced Excel, but over the final years I started to move
      ...
      I started to discover my passion for programming. I remember saying repeatedly in DC and abroad
