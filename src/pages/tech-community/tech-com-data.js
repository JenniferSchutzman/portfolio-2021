...
export const cardData = [
    {
        ...
        description: "in charge of overseeing the strategic vision of the organiza)on and leading business decisions to drive growth in membership and impact to the community. Duties include collaborating with the Board of Directors, implemen)ng strategic plans for the organiza)on’s development and managing relatonships with stakeholders.",
